...
/**
 * When in the {@link com.ericsson.cifwk.tdm.api.model.ApprovalStatus#REJECTED} state a datasource can only
 * transition to {@link com.ericsson.cifwk.tdm.api.model.ApprovalStatus#UNAPPROVED}.
 */
class Rejected extends DataSourceStateTemplate implements DataSourceState {
